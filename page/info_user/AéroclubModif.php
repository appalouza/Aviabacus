...
<div class="form-row">
    ...
    <div class="form-group col-md-4">
        ...
        <input type="Date"  name="dateEntree" class="form-control" value="<?php echo $aeroclub['modif']->dateEntree;?>">
    </div>
    ...
    <div class="form-group col-md-4">
        ...
        <input type="Date"  name="dateCotis" class="form-control" value="<?php echo $aeroclub['modif']->dateCotis;?>">
    </div>
    ...
    <div class="form-group col-md-4">
        ...
        <input type="Date" name="dateFinCotis" class="form-control" value="<?php echo $aeroclub['modif']->dateFinCotis;?>">
    </div>
</div>
...
<div class="form-row">
    <div class="form-group col-md-2">
        ...
        <select class="form-control"  name = "mActif">
            ...
            <option <?php if($aeroclub['modif']->mActif == 1 ){echo 'selected=\'selected\'';}?> value="1">Oui</option>
            <option <?php if($aeroclub['modif']->mActif == 0 ){echo 'selected=\'selected\'';}?>value="0">Non</option>
        </select>
    </div>
    ...
    <div class="form-group col-md-2">
        ...
        <select class="form-control"  name = "bours">
            <option value="2"></option>
            <option <?php if($aeroclub['modif']->bours == 1 ){echo 'selected=\'selected\'';}?> value="1">Oui</option>
            <option <?php if($aeroclub['modif']->bours == 0 ){echo 'selected=\'selected\'';}?> value="0">Non</option>
        </select>
    </div>
</div>
<div class="form-row">
    <div class="form-group col-md-6">
        ...
        <select class="form-control"  name="lMembre">
            <option></option>
            <option <?php if($aeroclub['modif']->lMembre == 1 ){echo 'selected=\'selected\'';}?> value="1">Membre actif FNA à notre club</option>
            <option <?php if($aeroclub['modif']->lMembre == 2 ){echo 'selected=\'selected\'';}?> value="2">Membre actif FNA ou majoritaire club voisin</option>
            <option <?php if($aeroclub['modif']->lMembre == 3 ){echo 'selected=\'selected\'';}?> value="3">Membre du bureau</option>
            <option <?php if($aeroclub['modif']->lMembre == 4 ){echo 'selected=\'selected\'';}?> value="4">Membre du conseil d'administration</option>
            <option <?php if($aeroclub['modif']->lMembre == 5 ){echo 'selected=\'selected\'';}?> value="5">Membre du conseil d'administration instructeur</option>
            <option <?php if($aeroclub['modif']->lMembre == 6 ){echo 'selected=\'selected\'';}?> value="6">Membre exclu</option>
            <option <?php if($aeroclub['modif']->lMembre == 7 ){echo 'selected=\'selected\'';}?> value="7">Membre non-actif cotisation spéciale</option>
            <option <?php if($aeroclub['modif']->lMembre == 8 ){echo 'selected=\'selected\'';}?> value="8">Membre sans cotisation depuis plus de deux ans</option>
            <option <?php if($aeroclub['modif']->lMembre == 9 ){echo 'selected=\'selected\'';}?> value="9">Membre stagiaire sans cotisation depuis plus de deux ans</option>
            <option <?php if($aeroclub['modif']->lMembre == 10 ){echo 'selected=\'selected\'';}?> value="10">Président</option>
            <option <?php if($aeroclub['modif']->lMembre == 11 ){echo 'selected=\'selected\'';}?> value="11">Président d'honneur</option>
            <option <?php if($aeroclub['modif']->lMembre == 12 ){echo 'selected=\'selected\'';}?> value="12">Vice-président</option>
        </select>
    </div>
</div>
